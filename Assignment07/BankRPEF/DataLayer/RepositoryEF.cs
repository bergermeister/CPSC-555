   ...
   public class RepositoryEF : IRepositoryBanking, IRepositoryAuthentication
   {
      ...
      public List<TransactionHistoryVM> GetTransactionHistory( long checkingAccountNum, long savingAccountNum )
      {
         try
         {
            ...
            THList = CacheAbstractionHelper.CABS.Retrieve<List<TransactionHistoryVM>>( "TRHISTORY_"+checkingAccountNum+savingAccountNum );
            if( THList == null )
            {
               ...
               THList = res;
               CacheAbstractionHelper.CABS.Insert( "TRHISTORY_" + checkingAccountNum + savingAccountNum, THList );
            }
            return ( THList );
         }
         catch( Exception )
